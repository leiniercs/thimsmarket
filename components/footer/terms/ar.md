...
يمكن شراء المنتجات المقدمة عبر الإنترنت من خلال صفحة الدفع الخاصة بنا (https://pay.thims.market). يحتاج المستخدم إلى إدخال معلومات دفع دقيقة لتنفيذ عملية شراء ناجحة من خلال طرق الدفع المدعومة.

يمكن شراء المنتجات باستخدام بطاقة خصم/ائتمان صالحة من Visa أو Mastercard بالعملة AED. سيكون السعر والعملة المعروضان في صفحة الدفع نفس السعر والعملة المطبوعة على إيصال المعاملة وسيتم عرض المبلغ المحسوب على البطاقة بعملة بطاقتك.

من المستحسن أن يحتفظ حاملو البطاقات بنسخ من سجلات المعاملات وأن يلتزموا بسياسات وقواعد التاجر.
